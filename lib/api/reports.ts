...
export const getDispensingLog = (id: string): Promise<any> => posApi.get(`/dispensing-logs/${id}`);
export const getDispensingLogsByPatient = (patientId: string): Promise<any> => posApi.get(`/dispensing-logs/patient/${patientId}`);
